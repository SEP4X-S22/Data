...
import com.Apharma.sep4.Persistence.DataWarehouse.DataWarehouseDAO.DataWarehouseDAO;
import com.Apharma.sep4.Persistence.DataWarehouse.DataWarehouseDAO.iDataWarehouseDAO;
...
public class PersistenceConfig
{
  ...
  //TODO purge before handing in, only needed for seeding with dummy data
  @Bean
  ...
  /**
   ...
   @return Singleton instance of DataWarehouseDAO
   */
  @Bean
  @Scope("singleton")
  ...
  /**
   Method for getting a ReadingDAO.
   
   @return Singleton instance of ReadingDAO
   */
  @Bean
  @Scope("singleton")
